# DONNÉES D'IMPORT — Chimie Terminale C (3 thèmes, hors périmètre : aucun,
# la chimie Tle C tient entièrement dans ces 3 thèmes).
# Source : programme officiel nigérien (PDF second cycle, pages 324-332).
# En chimie : 1 chapitre = 1 notion (comme la physique, pas de sous-notions).
#
# Copie strictement inchangée de DONNEES_import_chimie_tleC.py (racine du
# dépôt) — nom préfixé d'un "_" pour que Django ignore ce module lors de la
# découverte des commandes (voir django.core.management.find_commands, qui
# exclut explicitement les fichiers commençant par "_"), donc il vit "à côté
# de la commande" (programme/management/commands/) sans apparaître comme une
# fausse commande dans `manage.py help` — même convention que
# _donnees_physique_tle_c.py.
