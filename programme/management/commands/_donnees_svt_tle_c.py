...
#
# Copie strictement inchangée de DONNEES_import_svt_tleC.py (racine du
...
# et _donnees_chimie_tle_c.py.
#
# ATTENTION (vérifié en comptant programmatiquement le contenu ci-dessous,
# PAS en se fiant au commentaire d'origine du fichier source qui annonçait à
# tort "8 chapitres") : cette liste contient réellement 5 THÈMES et 10
# CHAPITRES (= 10 NOTIONS, 1 par chapitre) : 3+2+3+1+1. Voir le rapport de
# l'agent pour le détail de cet écart.
...
# Récapitulatif RÉEL (vérifié programmatiquement, voir en-tête) : 5 thèmes,
# 10 chapitres (= 10 notions) — PAS 8, malgré le commentaire d'origine du
# fichier source.
