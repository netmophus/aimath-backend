...
#
# Copie strictement inchangée de DONNEES_import_maths_tleD.py (racine du
# dépôt) — nom préfixé d'un "_" pour que Django ignore ce module lors de la
# découverte des commandes, même convention que _donnees_physique_tle_c.py /
# _donnees_chimie_tle_c.py / _donnees_svt_tle_c.py.
#
# STRUCTURE MIXTE (contrairement à la physique/chimie où 1 chapitre = 1
# notion) : un chapitre peut porter soit une clé "notions": [...] (plusieurs
# notions, chacune avec son propre titre/contenus/objectifs/commentaires),
# soit directement les clés contenus/objectifs/commentaires SUR le chapitre
# (une seule notion, dont le titre reprend celui du chapitre). La commande
# importer_maths_td.py gère les deux cas.
#
# Comptage vérifié programmatiquement sur le contenu ci-dessous (pas sur le
# commentaire d'origine, qui pour une fois est exact) : 3 thèmes, 12
# chapitres, 19 notions.
